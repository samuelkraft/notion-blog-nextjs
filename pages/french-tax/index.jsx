...
const FrenchTax = ({ }) => {
	...
	return (
		<>
			<Head>
				<title>{router.locale === "fr" ? "Fiscalité privée française : nos prestations" : "French Private Tax : Our Services" || "Fiscalité privée française : nos prestations"}</title>
						...
						<LayoutColumn>
							<TextContent>
								...
								<Heading>
									<RowWrapper className=''>
										<Image src={check} alt='check1' width={50} height={50} />
										<Heading>{t("section2_bullet9")}</Heading>
									</RowWrapper>
									<RowWrapper className=''>
										<Image src={check} alt='check1' width={50} height={50} />

										<Heading>{t("section2_bullet10")}</Heading>
									</RowWrapper>

									<RowWrapper>
										<Image src={check} alt='check1' width={50} height={50} />

										<Heading>{t("section2_bullet11")}</Heading>
									</RowWrapper>

									<RowWrapper>
										<Image src={check} alt='check1' width={50} height={50} />

										<Heading>{t("section2_bullet12")}</Heading>
									</RowWrapper>
								</Heading>
							</TextContent>
						</LayoutColumn>
					...
					<div className={classes.wrapper}>
						<LayoutColumn>
							<TextContent>
								...
								<Subtitle>{t("section3_subtitle4")}</Subtitle>
								<Heading>
								...
								<Heading>
									...
									<RowWrapper>
										...
										<Heading>{t("section3_bullet10")}</Heading>
									</RowWrapper>
								</Heading>
							</TextContent>
