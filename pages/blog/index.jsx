			...
			<main className={styles.container}>
				<header className={styles.header}>
					...
					<p>
						...
						<Link href={`https://www.notion.so/${databaseId}`}>this table</Link>. Get
						the source code on{" "}
						<Link href="https://github.com/samuelkraft/notion-blog-nextjs">
							Github
						</Link>{" "}
						or read{" "}
						<Link href="https://samuelkraft.com/blog/building-a-notion-blog-with-public-api">
							my blogpost
						</Link>{" "}
