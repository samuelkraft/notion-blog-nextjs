...
const AccountingServices = ({ }) => {
	...
	useEffect(() => {
		i18n.reloadResources(i18n.resolvedLanguage, ["accountingServices", "common"]);
	}, [router.locale]);
	...
	return (
		<>
			<Head>
				<title>{router.locale === "fr" ? "Comptable dédié pour entreprise étrangère" : "French Accounting Firm for International Companies" || "Comptable dédié pour entreprise étrangère"}</title>
...
const getStaticProps = async ({ locale }) => {
	...
	return {
		props: {
			...(await serverSideTranslations(locale, ["accountingServices", "common"])),
		},
		revalidate: 60,
	};
};
