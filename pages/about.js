  ...
  return (
    ...
    <div class="flex-grow">
      ...
      <div class="w-4/5 mx-auto mt-32 ">
            ...
            <div class="mt-6" >
                    <a href="contact" class="inline-block text-m px-4 py-2 my-auto leading-none border rounded-full text-white bg-black border-black hover:border-stone-400 hover:text-stone-400 hover:bg-white mt-4 sm:mt-0">contact me</a>
                </div>
