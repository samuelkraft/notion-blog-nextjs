            ...
            <nav class=" flex w-4/5 mx-auto items-center text-center justify-between inline-block align-middle flex-wrap py-5 ">
                ...
                <div id='menu' class={ (isExpanded? "" : "hidden") + " text-right w-full block flex-grow sm:flex sm:items-center sm:w-auto"  }>
                    <div class="text-md sm:flex-grow">
                        <a href="blog" class="block mt-4 text-right sm:inline-block sm:mt-0 text-black hover:text-stone-400 focus:text-stone-400 active:text-stone-400 sm:mr-10">
                    blog
                        </a>
                        <a href="about" class="block mt-4  sm:inline-block sm:mt-0 text-black hover:text-stone-400 sm:mr-10">
                    about
                        </a>
                    </div>
                    <div>
